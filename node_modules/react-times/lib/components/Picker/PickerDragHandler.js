...
var defaultProps = {
  ...
  minLength: _const_value.MIN_ABSOLUTE_POSITION,
  maxLength: _const_value.MAX_ABSOLUTE_POSITION,
  minuteStep: 5,
  limitDrag: false,
    ...
    value: function handleMouseMove(e) {
      if (this.state.draging) {
        ...
        if (this.originX !== dragX && this.originY !== dragY) {
          ...
          var absolutePosition = this.getAbsolutePosition(dragX, dragY);
          var height = _drag2.default.validatePosition(absolutePosition, minLength - _const_value.POINTER_RADIUS, maxLength - _const_value.POINTER_RADIUS);
          var top = _const_value.PICKER_RADIUS - height;
          this.setState({
            top: top,
            height: height,
            pointerRotate: pointerRotate
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            {
              ...
              onMouseDown: draggable ? this.handleMouseDown : function () {},
              onTouchStart: draggable ? this.handleMouseDown : function () {}
            },
            time
          )
        ),
