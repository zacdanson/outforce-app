  ...
  return function (_React$PureComponent) {
    ...
    _createClass(PickerPointGenerator, [{
      ...
      value: function renderMinutePointes() {
        ...
        return _const_value.MINUTES.map(function (m, index) {
          ...
          if (index % 5 === 0) {
            return _react2.default.createElement(_PickerPoint2.default, {
              ...
              key: index,
              angle: angle,
              handleTimeChange: _this2.props.handleTimePointerClick,
      ...
      value: function renderHourPointes() {
        ...
        var hours = parseInt(mode, 10) === 24 ? _const_value.HOURS : _const_value.TWELVE_HOURS;
        return hours.map(function (h, index) {
          ...
          return _react2.default.createElement(_PickerPoint2.default, {
            ...
            handleTimeChange: _this3.props.handleTimePointerClick,
