...
var _const_value = require('../../utils/const_value.js');
...
var TwentyFourHoursMode = function (_React$PureComponent) {
  ...
  _createClass(TwentyFourHoursMode, [{
    ...
    value: function handleTimePointerClick(options) {
      ...
      pointerRotate && this.setState({ pointerRotate: pointerRotate });
    ...
    value: function resetHourDegree() {
      ...
      var pointerRotate = 0;
      _const_value.HOURS.forEach(function (h, index) {
        if (hour === index + 1) {
    ...
    value: function resetMinuteDegree() {
      ...
      var pointerRotate = 0;
      _const_value.MINUTES.forEach(function (m, index) {
        if (minute === index) {
    ...
    value: function getTopAndHeight() {
      ...
      var minLength = step === 0 ? _const_value.MIN_ABSOLUTE_POSITION : _const_value.MAX_ABSOLUTE_POSITION;
      var height = time < splitNum ? minLength - _const_value.POINTER_RADIUS : _const_value.MAX_ABSOLUTE_POSITION - _const_value.POINTER_RADIUS;
      var top = time < splitNum ? _const_value.PICKER_RADIUS - minLength + _const_value.POINTER_RADIUS : _const_value.PICKER_RADIUS - _const_value.MAX_ABSOLUTE_POSITION + _const_value.POINTER_RADIUS;
      return [top, height];
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_PickerDragHandler2.default, {
            ...
            minLength: step === 0 ? _const_value.MIN_ABSOLUTE_POSITION : _const_value.MAX_ABSOLUTE_POSITION,
            handleTimePointerClick: this.handleTimePointerClick
          })
        ),
