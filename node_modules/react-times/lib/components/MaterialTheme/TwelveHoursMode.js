...
var TwelveHoursMode = function (_React$PureComponent) {
  ...
  _createClass(TwelveHoursMode, [{
    ...
    value: function resetHourDegree() {
      ...
      var pointerRotate = 0;
      _const_value.TWELVE_HOURS.forEach(function (h, index) {
        if (hour === index + 1) {
    ...
    value: function getHourTopAndHeight() {
      var height = _const_value.MIN_ABSOLUTE_POSITION - _const_value.POINTER_RADIUS;
      var top = _const_value.PICKER_RADIUS - _const_value.MIN_ABSOLUTE_POSITION + _const_value.POINTER_RADIUS;
      return [top, height];
    }
  }, {
    key: 'getMinuteTopAndHeight',
    value: function getMinuteTopAndHeight() {
      var height = _const_value.MAX_ABSOLUTE_POSITION - _const_value.POINTER_RADIUS;
      var top = _const_value.PICKER_RADIUS - _const_value.MAX_ABSOLUTE_POSITION + _const_value.POINTER_RADIUS;
      return [top, height];
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_PickerDragHandler2.default, {
            ...
            minLength: _const_value.MAX_ABSOLUTE_POSITION,
            draggable: draggable,
            handleTimePointerClick: this.handleMinutePointerClick
          }),
          _react2.default.createElement(_PickerDragHandler2.default, {
            ...
            maxLength: _const_value.MIN_ABSOLUTE_POSITION,
            draggable: draggable,
            handleTimePointerClick: this.handleHourPointerClick
          })
        ),
